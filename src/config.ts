...
const CONFIG_KEYS = [
	...
	"CHAT_MESSAGES_CHANNEL_WEBHOOK_URL",
	"CHAT_MESSAGES_CHANNEL_ID",
	"DEATH_MESSAGES_CHANNEL_WEBHOOK_URL",
	"DEATH_MESSAGES_CHANNEL_ID",
	"ACHIEVEMENT_MESSAGES_CHANNEL_WEBHOOK_URL",
	"ACHIEVEMENT_MESSAGES_CHANNEL_ID",
	"JOIN_MESSAGES_CHANNEL_WEBHOOK_URL",
	"JOIN_MESSAGES_CHANNEL_ID",
	"LEAVE_MESSAGES_CHANNEL_WEBHOOK_URL",
